				...
				<div class="panel-body">
					<table 
						...
						<tbody>
							...
							INNER JOIN category 
							ON product.cat_id=category.cat_id ORDER BY prd_id ASC LIMIT $per_row, $rows_per_page";
							...
							?>
								<tr>
									...
									<td class="form-group">
										...
										<a	onclick="return thongbao('<?php echo $row['prd_name']; ?>')" href="del_product.php?prd_id=<?php echo $row['prd_id']; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
									</td>
								</tr>
							<?php } ?>
							 </tbody>
